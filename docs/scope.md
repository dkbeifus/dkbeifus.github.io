...
* Main web page to contain the following:
      1.  Use a stylesheet to style the page
      1.  Link to the About page
      1.  A checkable checklist for OBS setup
      1.  A checkable checklist for Freeshow setup
      1.  A checkable checklist for Stream Audio PC setup
      1.  A noncheckable checklist for Starting the service
      1.  A noncheckable checklist for what to do during service
      1.  A noncheckable checklist for Ending the service
  
 * About page document will be named **about.html**

* About page to contain the following:
      1.  Use the same stylesheet as the main web page 
      1.  Link back to the main page
      1.  Provide a high level description of the overall setup
